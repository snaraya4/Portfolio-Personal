...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hi, I'm Sravya.</span> I'm a{" "}
      ...
      >
        ...
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-2xl rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
